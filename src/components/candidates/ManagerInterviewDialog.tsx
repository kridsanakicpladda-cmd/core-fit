...
interface ManagerInterviewDialogProps {
...
export function ManagerInterviewDialog({ 
  candidateName, 
  position,
  interview, 
  open, 
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-lg">แบบประเมินผลการสัมภาษณ์ผู้สมัครงาน - First Interview (Manager)</DialogTitle>
        </DialogHeader>
